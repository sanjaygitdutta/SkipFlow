...
class AdAudioController(context: Context) {
    ...
    companion object {
        ...
        private const val DEFAULT_MUTE_WATCHDOG_MS = 35_000L // 35s failsafe watchdog (safe for all ads; active poller dynamically extends for lengthier 45s-120s ads)
